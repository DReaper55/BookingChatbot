...
def train_model(output_dir):
    ...
    # Load dataset
    # train_dataloader = load_and_preprocess_data(get_path_to(AssetPaths.TRAINING_DATASET.value))
    # val_dataloader = load_and_preprocess_data(get_path_to(AssetPaths.VALIDATION_DATASET.value))

    train_dataloader, val_dataloader = load_and_preprocess_data(get_path_to(AssetPaths.SYNTHETIC_DATASET.value), split_dataset=True)
