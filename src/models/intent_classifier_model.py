...
from src.data.load_dataset import load_intent_classifier_dataset, load_rag_dataset
...
def train_model(output_dir):
    ...
    train_dataloader, val_dataloader = load_rag_dataset(for_booking_finetune=False, for_intent_finetune=True)
