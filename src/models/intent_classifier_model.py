...
from src.data.load_dataset import load_intent_classifier_dataset, load_finetune_dataset
...
def train_model(output_dir):
    ...
    # Load dataset to further finetune intent-classifier model
    # train_dataloader, val_dataloader = load_finetune_dataset(for_booking_finetune=False, for_intent_finetune=True)
